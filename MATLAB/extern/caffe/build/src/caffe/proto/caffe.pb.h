...
enum LayerParameter_LayerType {
  ...
  LayerParameter_LayerType_MASKED_WINDOW_DATA = 30,
  LayerParameter_LayerType_PI_WINDOW_DATA = 31
};
...
const LayerParameter_LayerType LayerParameter_LayerType_LayerType_MAX = LayerParameter_LayerType_PI_WINDOW_DATA;
...
class LayerParameter : public ::google::protobuf::Message {
 public:
  ...
  static const LayerType MASKED_WINDOW_DATA = LayerParameter_LayerType_MASKED_WINDOW_DATA;
  static const LayerType PI_WINDOW_DATA = LayerParameter_LayerType_PI_WINDOW_DATA;
